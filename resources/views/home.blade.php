...
@section('main')
    <h4 class="text-center pb-4">Questi sono tutti i treni disponibili, se invece vuoi vedere i treni in partenza oggi,
        clicca
        sotto</h4>
    <a href="{{ route('today') }}"><button class="btn btn-danger text-uppercase">Treni in partenza oggi</button></a>
    <ul class="row">
